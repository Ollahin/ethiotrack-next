...
function OperationsToolPage() {
  ...
  const handleBootstrap = async () => {
    try {
      const { authority: auth, keyPair } = await createOperationsAuthority("ops-v1-" + Date.now().toString(36));
      setAuthority(auth);
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <header className="flex items-center justify-between border-b border-zinc-800 pb-6">
          ...
          <div className="flex gap-2">
             <Button variant="outline" className="border-zinc-800 bg-zinc-900" onClick={handleBootstrap}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {authority ? (
              <div className="space-y-4">
                <div className="space-y-1">
                  <label className="text-[10px] uppercase text-zinc-500 font-bold">Public Key (Customer Bundle)</label>
                  <div className="flex gap-2">
                    ...
                    <Button size="icon" variant="ghost" onClick={() => copyToClipboard(authority.publicKeyB64)}>
                ...
                <div className="pt-4 flex gap-2">
                  <Button className="flex-1 bg-amber-600 hover:bg-amber-700" onClick={handleExportKey}>
              ...
              <div className="space-y-4">
                <p className="text-sm text-zinc-500 italic">No authority loaded. Generate one or import.</p>
                <div className="space-y-2">
                  ...
                  />
                  <Button variant="outline" className="w-full border-zinc-800" onClick={handleImportKey}>
          ...
          <section className="space-y-4 bg-zinc-900/50 p-6 rounded-xl border border-zinc-800">
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                <label className="text-[10px] uppercase text-zinc-500 font-bold">Installation ID</label>
                <Input 
        ...
        {result && (
          <section className="space-y-4 bg-zinc-900/50 p-6 rounded-xl border border-zinc-800">
             <div className="flex items-center justify-between">
               ...
               <Button size="sm" variant="outline" className="border-zinc-800" onClick={() => copyToClipboard(result)}>
